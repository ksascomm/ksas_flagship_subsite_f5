			...
			<?php endwhile; endif; ?>
				...
				<li class="person">
					<div class="row">
						...
						<a href="<?php the_permalink();?>" title="<?php the_title(); ?>"><h3 class="no-margin"><?php the_title(); ?></h3></a>
						
						<p class="no-margin">
							<?php if ( get_post_meta($post->ID, 'ecpt_class_year', true) ) : ?>
								<span class="attribute"><strong>Year:&nbsp;</strong>
								<?php echo get_post_meta($post->ID, 'ecpt_class_year', true); ?></span>
							<?php endif; ?>
							<br>
							<?php if (has_term('','academicdepartment', $post->ID) == true || has_term('','affiliation', $post->ID) == true) { ?><span class="attribute"><strong>Affiliations:</strong> <?php } ?>
							...
							<?php if ( get_post_meta($post->ID, 'ecpt_article_list', true) || get_post_meta($post->ID, 'ecpt_research_pdf', true) || get_post_meta($post->ID, 'ecpt_video', true) ) : ?><h6 class="no-margin"><strong>Multimedia:&nbsp;</strong><?php endif; ?>
